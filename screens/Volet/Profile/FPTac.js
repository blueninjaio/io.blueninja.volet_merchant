...
export class FPTac extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    console.log("Old Password: ", this.props.navigation.state.params.oldPwd);
        ...
        .then(data => {
          if (data.success === true) {
            this.props.navigation.navigate("ConfirmPassword", {
              ...
              temporary_password: this.props.navigation.state.params.oldPwd
            });
          } else {
