      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={styles.payments}>
            <TouchableOpacity>
              <Image source={require('../../../assets/transHis.png')} resizeMode="contain" style={{ width: 100, height: 100 }} />
            </TouchableOpacity>

            <TouchableOpacity>
              <Image source={require('../../../assets/PenOrder.png')} resizeMode="contain" style={{ width: 100, height: 100 }} />
            </TouchableOpacity>
          </View>
        </ScrollView>
